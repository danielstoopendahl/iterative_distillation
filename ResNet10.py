...
from ResNet14 import ResNet14

# 91.0% accuracy, (didn't finish training)
...
class ResNetCIFAR(nn.Module):
    def __init__(self, block, layers, num_classes=10):
        ...
        self.inserted_fc = nn.Linear(128, hidden_dim)
...
def main():
    ...
    teacher = ResNet14().to(device)
    teacher.load_state_dict(torch.load('models/resnet14_cifar10.pth'))
    ...
    torch.save(model.state_dict(), "models/resnet10_cifar10.pth")
    print("Model saved to models/resnet10_cifar10.pth")
