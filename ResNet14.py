...
class ResNetCIFAR(nn.Module):
    def __init__(self, block, layers, num_classes=10):
        ...
        self.inserted_fc = nn.Linear(256, hidden_dim)
...
def main():
    ...
    model = ResNet14(num_classes=10).to(device)
    ...
    torch.save(model.state_dict(), "models/resnet14_cifar10.pth")
    print("Model saved to models/resnet14_cifar10.pth")
