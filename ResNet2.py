...
# 58% accuracy, hidden layer size 524288 I think, teacher: ResNet-6
# Maybe this model is just bad, bottleneck CNN
...
def main():
    ...
    model = ResNet2(num_classes=10).to(device)
    print("continuing from previous save")
    model.load_state_dict(torch.load('models/resnet2_cifar10.pth'))
    ...
    teacher.load_state_dict(torch.load('models/resnet6_cifar10.pth'))
    ...
    torch.save(model.state_dict(), "models/resnet2_cifar10.pth")
    print("Model saved to models/resnet2_cifar10.pth")
