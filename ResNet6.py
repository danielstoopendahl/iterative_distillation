...
# 88% accuracy (could train for longer)
...
def main():
    ...
    model.load_state_dict(torch.load('models/resnet6_cifar10.pth'))

    optimizer = optim.Adam(model.parameters(), eps=1e-10, lr=1e-4)
    criterion = nn.MSELoss()

    print('loading teacher...')
    teacher = ResNet10().to(device)
    teacher.load_state_dict(torch.load('models/resnet10_cifar10.pth'))
    ...
    torch.save(model.state_dict(), "models/resnet6_cifar10.pth")
    print("Model saved to models/resnet6_cifar10.pth")
